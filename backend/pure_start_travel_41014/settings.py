"""
Django settings for pure_start_travel_41014 project.
...
ROOT_URLCONF = 'pure_start_travel_41014.urls'
...
WSGI_APPLICATION = 'pure_start_travel_41014.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pure_start_travel_41014 API",
    "DESCRIPTION": "API documentation for pure_start_travel_41014 App",
    "VERSION": "v1",
}
